...
function UpdateCard(){
    ...
    React.useEffect(() => {
        setTitle(courseDetails.course?.title as string);
        setDescription(courseDetails.course?.description as string);
        setImage(courseDetails.course?.imageLink as string);
        setPrice(courseDetails.course?.price as number);
        setPublished(courseDetails.course?.published as boolean);
      }, [courseDetails]);
    ...
    return <div>
            ...
            <Card variant="outlined" style={{width: 400, padding: 10}}>
                ...
                <TextField
                    ...
                    variant="outlined"
                    onChange={e => {
                        setPublished((e.target.value == 'true')? true: false)
                    }} />
